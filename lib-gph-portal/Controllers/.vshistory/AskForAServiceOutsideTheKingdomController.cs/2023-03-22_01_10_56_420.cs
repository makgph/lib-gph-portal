    ...
    public class AskForAServiceOutsideTheKingdomController : SurfaceController
    {
        ...
        public object PostScientificThesisRequest(RequestToDepositAScientificThesisFormModel from)
        {
            ...
            try
            {
                ...
                files.Add(nameof(from.thesisTitleFile), from.thesisTitleFile);
                files.Add(nameof(from.thesisFile), from.thesisFile);
                files.Add(nameof(from.subjectsIndexFile), from.subjectsIndexFile);
                files.Add(nameof(from.quarterCollectionFile), from.quarterCollectionFile);
                files.Add(nameof(from.introFile), from.introFile);
                files.Add(nameof(from.englishExtractFile), from.englishExtractFile);
                files.Add(nameof(from.collectionFile), from.collectionFile);
                files.Add(nameof(from.arabicExtractFile), from.arabicExtractFile);
