    ...
    public class AskForAServiceOutsideTheKingdomController : SurfaceController
    {
        ...
        public object PostScientificThesisRequest(RequestToDepositAScientificThesisFormModel from)
        {
            ...
            try
            {
                ...
                files.Add(nameof(from.thesisFile), from.thesisTitleFile);
                files.Add(nameof(from.subjectsIndexFile), from.thesisTitleFile);
                files.Add(nameof(from.quarterCollectionFile), from.thesisTitleFile);
                files.Add(nameof(from.introFile), from.thesisTitleFile);
                files.Add(nameof(from.englishExtractFile), from.thesisTitleFile);
                files.Add(nameof(from.collectionFile), from.thesisTitleFile);
                files.Add(nameof(from.arabicExtractFile), from.thesisTitleFile);
