    ...
    public class PotPhotographyRequestModel
    {
        ...
        public void GetLiberaries()
        {
            try
            {
                ...
                string MedadTokenKey = System.Web
                                            .Configuration
                                            .WebConfigurationManager
                                            .AppSettings["MedadTokenKey"];
                string MedadTokenValue = System.Web
                                            .Configuration
                                            .WebConfigurationManager
                                            .AppSettings["MedadTokenValue"];
                string MedadTenantKey = System.Web
                                            .Configuration
                                            .WebConfigurationManager
                                            .AppSettings["MedadTenantKey"];
                string MedadTenantValue = System.Web
                                            .Configuration
                                            .WebConfigurationManager
                                            .AppSettings["MedadTenantValue"];
