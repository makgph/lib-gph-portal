...
namespace sa.gov.libgph.Services
{
    public class GiftedBookService
    {
        public SearchResponse GetSearchResponse()
        {
            try
            {
                string GiftedBookURL = "http://dev-lib.cpt-it.com/api/api/GiftedBook/GetRecentAvailableGiftedBooksByLimit/50";
                ...
                var t2 = Task.Run(() => apiClient.GetAsync<GiftedBookResponse>("http://dev-lib.cpt-it.com/api/api/GiftedBook/GetRecentAvailableGiftedBooksByLimit/50"));
                //t2.Wait();
